 ...
 * @author Deleter
 * @version 2017年7月19日
 * @see OnLineListDataBase
 * @since
 */
public class OnLineListDataBase
{
    ...
    public synchronized static void put(String username, ChannelHandlerContext ctx)
    {
        if (userToCtx.containsKey(username)) return;
