...
{
    private static final long serialVersionUID = -2124276323219955776L;
    ...
    public boolean equals(Object obj)
    {
        ...
        if (localtion == null)
        {
            if (other.localtion != null)
                return false;
        }
        else if (!localtion.equals(other.localtion))
            return false;
        if (nickname == null)
        {
        ...
        if (picwall == null)
        {
            if (other.picwall != null)
                return false;
        }
        else if (!picwall.equals(other.picwall))
            return false;
        if (school == null)
        {
    ...
    {
        return "User [userId=" + userId + ", username=" + username + ", password=" + password + ", headImg=" + headImg
            + ", sign=" + sign + ", nickname=" + nickname + ", sex=" + sex + ", birthday=" + birthday + ", work="
            + work + ", company=" + company + ", school=" + school + ", localtion=" + localtion + ", country="
            + country + ", email=" + email + ", info=" + info + ", picwall=" + picwall + "]";
    }
